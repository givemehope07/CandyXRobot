    ...
    if msg.reply_to_message:
        ...
        try:
            ...
            if excp.message == "Participants_too_few":
                return msg.reply_text(
                    "↠ ʏᴏᴜʀ ɢʀᴏᴜᴩ ᴍᴜsᴛ ʜᴀᴠᴇ 100 ᴍᴇᴍʙᴇʀs ғᴏʀ sᴇᴛᴛɪɴɢ ᴀ sᴛɪᴄᴋᴇʀ ᴩᴀᴄᴋ ᴀs ɢʀᴏᴜᴩ sᴛɪᴄᴋᴇʀ ᴩᴀᴄᴋ !"
                )
...
def setchatpic(update: Update, context: CallbackContext):
    ...
    if user_can_changeinfo(chat, user, context.bot.id) is False:
        msg.reply_text("↠ ʏᴏᴜ ᴅᴏɴ'ᴛ ʜᴀᴠᴇ ᴩᴇʀᴍɪssɪᴏɴs ᴛᴏ ᴄʜᴀɴɢᴇ ɢʀᴏᴜᴩ ɪɴғᴏ !")
        return
    ...
    if msg.reply_to_message:
        ...
        msg.reply_text("↠ɴᴏᴏʙ, ʀᴇᴩʟʏ ᴛᴏ ᴀ ᴩʜᴏᴛᴏ ᴏʀ ғɪʟᴇ ᴛᴏ sᴇᴛ ɪᴛ ᴀs ɢʀᴏᴜᴩ ᴩʀᴏғɪʟᴇ ᴩɪᴄ !")
...
def set_desc(update: Update, context: CallbackContext):
    ...
    try:
        if len(desc) > 255:
            return msg.reply_text(
                "↠sᴇᴅ, ᴅᴇsᴄʀɪᴩᴛɪᴏɴ ᴍᴜsᴛ ʙᴇ ʟᴇss ᴛʜᴀɴ 255 ᴡᴏʀᴅs ᴏʀ ᴄʜᴀʀᴀᴄᴛᴇʀs !"
            )
...
def promote(update: Update, context: CallbackContext) -> str:
    ...
    if (
        ...
        message.reply_text("↠ ᴋɪᴅ, ʏᴏᴜ ᴅᴏɴ'ᴛ ʜᴀᴠᴇ ᴩᴇʀᴍɪssɪᴏɴs ᴛᴏ ᴀᴅᴅ ɴᴇᴡ ᴀᴅᴍɪɴs !")
        return
    ...
    if user_id == bot.id:
        message.reply_text(
            "» ɪ ᴄᴀɴ'ᴛ ᴩʀᴏᴍᴏᴛᴇ ᴍʏsᴇʟғ, ᴅᴇᴠᴀɴsʜ ᴅɪᴅɴ'ᴛ ᴛᴏʟᴅ ᴍᴇ ᴛᴏ ᴅᴏ sᴏ."
        )
        return
...
def demote(update: Update, context: CallbackContext) -> str:
    ...
    if user_member.status == "creator":
        message.reply_text(
            "↠ ᴛʜᴀᴛ ᴜsᴇʀ ɪs ᴏᴡɴᴇʀ ᴏғ ᴛʜᴇ ᴄʜᴀᴛ ᴀɴᴅ ɪ ᴅᴏɴ'ᴛ ᴡᴀɴᴛ ᴍʏsᴇʟғ ᴛᴏ ɢᴇᴛ ᴋɪᴄᴋᴇᴅ."
        )
        return
    ...
    if user_id == bot.id:
        message.reply_text("↠ ɪ ᴄᴀɴ'ᴛ ᴅᴇᴍᴏᴛᴇ ᴍʏsᴇʟғ, ʙᴜᴛ ɪғ ʏᴏᴜ'ʀᴇ ɴᴏᴛ ʜᴀᴘᴘʏ ᴡɪᴛʜ ᴍᴇ ɪ ᴄᴀɴ ʟᴇᴀᴠᴇ.")
        return
...
def set_title(update: Update, context: CallbackContext):
    ...
    if user_member.status == "creator":
        message.reply_text(
            "↠ ᴛʜᴀᴛ ᴜsᴇʀ ɪs ᴏᴡɴᴇʀ ᴏғ ᴛʜᴇ ᴄʜᴀᴛ ᴀɴᴅ ɪ ᴅᴏɴ'ᴛ ᴡᴀɴᴛ ᴍʏsᴇʟғ ᴋɪᴄᴋᴇᴅ ᴏᴜᴛ.",
        )
        return
...
def pinned(update: Update, context: CallbackContext) -> str:
    ...
    if chat.pinned_message:
        ...
        msg.reply_text(
            f"↠ ᴡᴛғ, ᴛʜᴇʀᴇ's ɴᴏ ᴩɪɴɴᴇᴅ ᴍᴇssᴀɢᴇ ɪɴ <b>{html.escape(chat.title)}!</b>",
            parse_mode=ParseMode.HTML,
        )
    ...
    if chat.username:
        ...
        if bot_member.can_invite_users:
            ...
            update.effective_message.reply_text(
                "↠ sᴇᴅ, ɪ ᴅᴏɴ'ᴛ ʜᴀᴠᴇ ᴩᴇʀᴍɪssɪᴏɴs ᴛᴏ ᴀᴄᴄᴇss ɪɴᴠɪᴛᴇ ʟɪɴᴋs !",
            )
    else:
        update.effective_message.reply_text(
